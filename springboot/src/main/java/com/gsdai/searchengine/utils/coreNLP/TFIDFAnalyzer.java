...
// adapted from https://github.com/huaban/jieba-analysis/blob/master/src/main/java/com/qianxinyao/analysis/jieba/keyword/TFIDFAnalyzer.java
public class TFIDFAnalyzer {
    ...
    public List<Keyword> analyze(String content, int topN) {
        ...
        if (idfMap == null) {
            idfMap = new HashMap<>();
            loadIDFMap(idfMap, this.getClass().getResourceAsStream("/nlp/idf_dict.txt"));
        }
    ...
    private Map<String, Double> getTF(String content) {
        ...
        List<CoreLabel> segTokens = coreNLPTokenizer.process(content);
